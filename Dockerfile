...
# sudo docker run -it     --privileged     --runtime=nvidia --gpus all     -e DISPLAY=$DISPLAY     -v /tmp/.X11-unix:/tmp/.X11-unix     --device=/dev/bus/usb     -v /dev/bus/usb:/dev/bus/usb     -v ~/project/bimanual_garment_folding:/workspace/bimanual_garment_folding -v ~/project/softgym:/workspace/softgym   garment_folding:latest
