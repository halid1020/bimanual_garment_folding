...
from .dataset_edge import ClothDatasetPointCloudEdge
from .utils.utils import extract_numbers
...
class VCConnection(object):
    ...
    def load_model(self, load_optim=False):
        ...
        #print('VCConnection: loaded model from', self.args.edge_model_path)
