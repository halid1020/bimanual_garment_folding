...
class BaseSkill:
    ...
    def _reached_goal_ori(self, info):
        ...
        goal_ori = self.get_global_euler_from_ori_ac(robot_controller, ori)
...
class AtomicSkill(BaseSkill):
    ...
    def get_param_dim(self):
        return self._config['robot_controller_dim'] + self._config['robot_gripper_dim']
...
class ReachOSCSkill(BaseSkill):
    ...
    def get_param_dim(self):
        return self._config['robot_control_dim']
...
class ReachSkill(BaseSkill):
    ...
    def get_param_dim(self):
        return self._config['robot_controller_dim']
...
class PushSkill(BaseSkill):
    ...
    def get_param_dim(self):
        return self._config['robot_controller_dim'] + 3
