...
class GarmentFlatteningTask(GarmentTask):
    ...
    def reward(self, last_info, action, info):#
        ...
        return {
            ...
            'algn_IoU': algn_IoU_reward(last_info, action, info),
            'algn_IoU_differance': algn_IoU_differance_reward(last_info, action, info),
            'algn_l2_tanh_reward': algn_l2_tanh_reward(last_info, action, info),
    ...
    def evaluate(self, arena):
        eval_dict = {
            ...
            'algn_l2_distance': self._get_algn_l2_distance(arena),
    ...
    def _get_algn_l2_distance(self, arena):
        pos = arena.get_mesh_particles_positions()
        goal_pos = arena.get_algn_mesh_particles_positions()
    ...
    def _get_deform_l2_distance(self, arena):
        ...
        goal_verts = arena.get_algn_mesh_particles_positions()
