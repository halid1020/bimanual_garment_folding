...
def click_points_pick_and_place(window_name, img, mask=None):
    ...
    print("\033[92m[real_robot.utils.human_utils] --- DUAL PICK & PLACE ---\033[0m")
    print("\033[92m[real_robot.utils.human_utils] UI: Click 'UNDO' button to remove last point.\033[0m")
    print("\033[92m[real_robot.utils.human_utils] Order: PICK0 -> PLACE0 -> PICK1 -> PLACE1\033[0m")
    print("\033[92m[real_robot.utils.human_utils] Press 'q' to cancel.\033[0m")
...
def click_points_single_pick_and_place(window_name, img, mask=None):
    ...
    print("\033[92m[real_robot.utils.human_utils] --- SINGLE PICK & PLACE ---\033[0m")
    print("\033[92m[real_robot.utils.human_utils] UI: Click 'UNDO' button to remove last point.\033[0m")
    print("\033[92m[real_robot.utils.human_utils] Order: PICK -> PLACE\033[0m")
    print("\033[92m[real_robot.utils.human_utils] Press 'q' to cancel.\033[0m")
...
def click_points_pick_and_fling(window_name, img, mask=None):
    ...
    print("\033[92m[real_robot.utils.human_utils] --- PICK & FLING ---\033[0m")
    print("\033[92m[real_robot.utils.human_utils] UI: Click 'UNDO' button to remove last point.\033[0m")
    print("\033[92m[real_robot.utils.human_utils] Order: PICK_0 -> PICK_1\033[0m")
    print("\033[92m[real_robot.utils.human_utils] Press 'q' to cancel.\033[0m")
